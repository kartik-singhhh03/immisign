...
export const ApplicationApprovalSchema = z.object({
  ...
  client_sent_at: z.string().optional().nullable(),
  client_signed_at: z.string().optional().nullable(),
  client_viewed_at: z.string().optional().nullable(),
  certificate_storage_path: z.string().optional().nullable(),
  certificate_generated_at: z.string().optional().nullable(),
  signed_document_path: z.string().optional().nullable(),
  created_at: z.string(),
  updated_at: z.string(),
