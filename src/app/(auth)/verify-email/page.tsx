...
export default function VerifyEmailPage() {
  return (
    <div className="flex min-h-[420px] flex-col justify-center gap-4 p-6 text-center">
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[#FAFAFA] text-[#111111]">
        <Mail className="h-7 w-7" />
      </div>
      <h1 className="text-2xl font-black text-[#111111]">Verify your email</h1>
      ...
      <Button asChild className="mx-auto mt-2 rounded-xl bg-[#111111] font-bold">
